                      ...
                      <div
                        className={clsx(
                          ...
                          (item.megaMenu || isHamburger)
                            ? "fixed left-1/2 -translate-x-1/2 w-[820px] max-w-[95vw] bg-white/95 dark:bg-gray-900/95 backdrop-blur-xl rounded-2xl border border-gray-100/60 dark:border-gray-800/60 px-8 py-10 mt-[1px] shadow-2xl" // Glassmorphic mega menu
                                  ...
                                  {group.categories.map((catName) => {
                                    ...
                                    return (
                                      <Link
                                        key={catName}
                                        href={subItem?.href || "#"}
                                        className="group/item flex items-center gap-3 p-2.5 rounded-xl hover:bg-red-50/50 dark:hover:bg-gray-800/50 transition-all duration-200"
                                      >
            ...
            <div className="flex items-center gap-2">
              ...
              >
                <button
                  ...
                  className={clsx(
                    "p-2 hover:text-brand-red transition-colors",
