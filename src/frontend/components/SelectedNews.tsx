        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 divide-y lg:divide-y-0 lg:divide-x divide-gray-200">
              ...
              {mainLead && (
                ...
                >
                  <div className="relative aspect-video rounded-xl overflow-hidden mb-4 bg-gray-100">
                    <Image
                      src={getProxiedImageUrl(mainLead.image, 800)}
                      alt={mainLead.title}
                      sizes="100vw"
                      fill
              ...
              {selectedList.map((item) => (
                ...
                >
                  <div className="relative w-28 h-20 shrink-0 rounded-lg overflow-hidden bg-gray-100">
                    <Image
                      src={getProxiedImageUrl(item.image, 300)}
                      alt={item.title}
                      sizes="100vw"
                      fill
                      className="object-cover group-hover:scale-105 transition-transform duration-500 ease-in-out"
            ...
            <div className="lg:col-span-3 lg:pl-6">
              <h3 className="text-brand-red mb-5 capitalize text-xl tracking-tight flex items-center gap-2 font-bold">
