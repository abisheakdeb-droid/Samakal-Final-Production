...
export default function Footer({ settings }: FooterProps) {
  ...
  const footerLinks = [
    { title: "বাংলাদেশ", url: "/category/bangladesh" },
    { title: "রাজনীতি", url: "/category/politics" },
    { title: "বিশ্ব", url: "/category/world" },
    { title: "খেলা", url: "/category/sports" },
    { title: "বিনোদন", url: "/category/entertainment" },
    { title: "অর্থনীতি", url: "/category/economics" },
    { title: "ফিচার", url: "/category/feature" },
    { title: "বিশেষ আয়োজন", url: "/category/special-arrangement" },
    { title: "কালের খেয়া", url: "/category/kaler-kheya" },
            ...
            <div className="flex gap-3">
              {[
                ...
                <Link key={idx} href="#" className={clsx(
                  "p-3 rounded-full bg-white/5 text-white transition-all duration-300",
                  color
                )}>
                  <Icon size={20} />
                </Link>
          ...
          <div className="md:col-span-3">
            ...
            <div className="mt-8 pt-8 border-t border-white/10">
              <p className="text-xs text-gray-500 text-center md:text-left leading-relaxed">
                © ২০০৫ - ২০২৬ {settings?.site_name || "সমকাল"}<br />সর্বস্বত্ব ® সংরক্ষিত
              </p>
            </div>
          </div>
