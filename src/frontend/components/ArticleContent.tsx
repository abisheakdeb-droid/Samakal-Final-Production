...
import { formatBanglaTime, formatBanglaDateTime } from "@/lib/utils";
      ...
      <div className="w-full border-t border-gray-100 dark:border-gray-800 mt-4 pt-6">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 bg-gray-50 dark:bg-gray-800/50 px-6 py-5 rounded-xl">
          ...
          <div className="flex items-center gap-3">
            ...
            <BookmarkButton
              articleId={article.id}
              className="p-2.5 border border-gray-200 rounded-lg hover:border-brand-red hover:bg-brand-red/5 text-gray-600 hover:text-brand-red transition-all"
            />

            <button
              onClick={handlePrint}
              className="p-2.5 border border-gray-200 rounded-lg hover:border-brand-red hover:bg-brand-red/5 text-gray-600 dark:text-gray-400 hover:text-brand-red transition-all"
              title="প্রিন্ট করুন"
            >
              <Printer size={18} />
            </button>
                      ...
                      <div className="flex flex-col">
                        ...
                        <div className="flex flex-wrap items-center gap-x-2 gap-y-1">
                          <span className="text-[11px] text-gray-500 dark:text-gray-400">
                            {news.author || article.author || "ডেস্ক"}
                          </span>
