  ...
  return (
    ...
    >
      ...
      */}
      ...
      <button
        className={clsx(
          "flex items-center justify-center p-2.5 rounded-lg transition-all duration-300 border border-gray-200 z-10",
          isHovered
            ? "bg-gray-100 text-gray-900 border-brand-red/20"
            : "text-gray-600 hover:text-brand-red hover:border-brand-red/30 hover:bg-red-50/50",
        )}
        title="শেয়ার করুন"
      >
        <Share2 size={20} />
