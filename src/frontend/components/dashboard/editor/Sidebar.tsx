...
import { Search, Clock, Calendar, Upload, FileText } from "lucide-react";
...
interface SidebarProps {
  onPublish: (_metadata: Partial<ArticleData>) => void;
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
                ...
                <div className="md:col-span-4">
                  <div className="bg-gray-50 p-6 rounded-xl border border-gray-100 h-full">
                    ...
                    <VideoEmbedder value={videoUrl} onChange={setVideoUrl} />
                  </div>
                </div>
              </div>
            )}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                ...
                <div className="bg-gray-50 p-6 rounded-xl border border-gray-100">
                  ...
                  <p className="text-xs text-gray-400 mt-3 leading-relaxed">
                    Add relevant tags to improve content discovery. Press Enter
                    to add.
                  </p>
                </div>
              </div>
                ...
                <div className="md:col-span-5">
                  <div className="bg-blue-50/50 p-6 rounded-xl border border-blue-100">
                    ...
                    <div className="mt-4 p-4 bg-white/60 rounded-lg text-xs text-blue-800 leading-relaxed">
                      <strong>Why Keywords?</strong> Although Google
                      doesn&apos;t strictly use meta keywords for ranking, they
                      can be helpful for other search engines and internal
                      tagging systems.
                    </div>
                  </div>
                </div>
