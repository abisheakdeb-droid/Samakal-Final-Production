      ...
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <aside className="w-full md:w-64 shrink-0 space-y-8">
          <div className="sticky top-24">
            <h3 className="font-bold text-gray-900 dark:text-gray-100 border-b border-gray-200 dark:border-gray-800 pb-2 mb-4">
              ফিল্টার
            </h3>

            {/* Date Filter */}
            <div className="mb-6">
              <h4 className="font-semibold text-gray-500 dark:text-gray-400 uppercase mb-3 text-xs tracking-wider">
                সময়
              </h4>
        ...
        <main className="flex-1">
          ...
          {results.length > 0 ? (
            <div className="space-y-8">
              {results.map((article) => (
                <Link
                  ...
                  className="group flex flex-col md:flex-row gap-4 md:gap-6 p-4 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-900/30 transition-all border-b border-gray-100 last:border-0"
                >
            ...
            <div className="bg-gray-50 dark:bg-gray-900 rounded-xl p-12 text-center border border-gray-100 dark:border-gray-800 animate-fade-in-up">
              <p className="text-xl text-gray-500 dark:text-gray-400 mb-2 font-bold">
                দুঃখিত, কোনো খবর পাওয়া যায়নি
              </p>
              <p className="text-sm text-gray-400 dark:text-gray-500">
                বানান সঠিক কিনা যাচাই করুন অথবা অন্য শব্দ দিয়ে খুঁজুন
              </p>
            </div>
          )}
        </main>
